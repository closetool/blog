...
func init() {
	...
	tables["auth_token"] = auth_tokenTableInfo
	tables["auth_user"] = auth_userTableInfo
	tables["auth_user_log"] = auth_user_logTableInfo
	tables["auth_user_social"] = auth_user_socialTableInfo
	tables["black_list"] = black_listTableInfo
	tables["category"] = categoryTableInfo
	tables["category_tags"] = category_tagsTableInfo
	tables["config"] = configTableInfo
	tables["friendship_link"] = friendship_linkTableInfo
	tables["menu"] = menuTableInfo
	tables["posts"] = postsTableInfo
	tables["posts_attribute"] = posts_attributeTableInfo
	tables["posts_comments"] = posts_commentsTableInfo
	tables["posts_tags"] = posts_tagsTableInfo
	tables["tags"] = tagsTableInfo
}
