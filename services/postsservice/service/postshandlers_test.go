...
func init() {
	initial.InitConfig("postsservice")
	...
	group := r.Group("/posts")
	routeutils.RegisterRoute(PostsRoutesTest, group)
}
func TestGetArchiveTotalByDateList(t *testing.T) {
	Convey("Given a request to /posts/archive/v1/list", t, func() {
		req := httptest.NewRequest("GET", "/posts/archive/v1/list", nil)
