...
var CategoryRoutes = []models.Route{
	...
	{Method: "POST", Pattern: "/category/v1/add", MiddleWare: gin.HandlersChain{middlewares.AdminToken}, HandlerFunc: transaction.Wrapper(saveCategory)},
	{Method: "GET", Pattern: "/statistics/v1/list", MiddleWare: gin.HandlersChain{middlewares.AdminToken}, HandlerFunc: statisticsList},
	{Method: "PUT", Pattern: "/category/v1/update", MiddleWare: gin.HandlersChain{middlewares.AdminToken}, HandlerFunc: transaction.Wrapper(updateCategory)},
	...
	{Method: "DELETE", Pattern: "/category/v1/:id", MiddleWare: gin.HandlersChain{middlewares.AdminToken}, HandlerFunc: transaction.Wrapper(deleteCategory)},
}
